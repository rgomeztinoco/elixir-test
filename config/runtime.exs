...
if config_env() == :prod do
  ...
  #
  config :rank_tracker_web, RankTrackerWeb.Endpoint, server: true
  #
  ...
  #
  #     config :rank_tracker_web, RankTrackerWeb.Mailer,
  ...
  config :hello_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
end
