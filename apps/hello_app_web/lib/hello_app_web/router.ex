defmodule HelloAppWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {HelloAppWeb.Layouts, :root}
  ...
  # scope "/api", HelloAppWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:hello_app_web, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HelloAppWeb.Telemetry
